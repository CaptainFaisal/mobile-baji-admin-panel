                ...
                <div class="main-page">
                    <div class="container-fluid">
                        <div class="row page-title-div">
                            <div class="col-md-6">
                                <h2 class="title">Manage Brands</h2>
...
{   ?>
                                                    <tr>
                                                        ...
                                                        <td><img src="<?php echo($result->img)?>" alt="Brand logo"
                                                                height="100px" />
                                                        </td>
                                                        <td><?php echo htmlentities($result->brand);?></td>
                                                        <td>
                                                            <a
                                                                href="edit-brand.php?brand_id=<?php echo htmlentities($result->brand_id);?>"><i
                                                                    class="fa fa-edit" title="Edit Record"></i> </a>
                                                            &nbsp;
                                                            &nbsp;
                                                            <a style="color:red;"
                                                                href="delete-brand.php?brand_id=<?php echo htmlentities($result->brand_id);?>"><i
