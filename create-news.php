...
$news=$_POST['news'];
$sql="INSERT INTO  news(news_img,news_title,news_subtitle,news) VALUES(:img,:title,:subtitle,:news);";
$query = $dbh->prepare($sql);
$query->bindParam(':title',$title,PDO::PARAM_STR);
$query->bindParam(':img',$destination,PDO::PARAM_STR);
$query->bindParam(':title',$title,PDO::PARAM_STR);
                                    ...
                                    <div class="panel">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <form method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group has-success">
                                                    <label class="control-label">News sub-title (optional)</label>
                                                    <div class="">
                                                ...
                                                <div class="form-group has-success">
                                                    ...
                                                    <div class="">
                                                        <textarea name="news" class="form-control" required="required"
                                                            cols='110' rows='5'></textarea>
                                                    </div>
                                                </div>
