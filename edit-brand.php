...
if(in_array($fileExtName,$allowed)){
    if($fileError === 0){
        ...
        $destination = 'brand-logos/'.$fileNameNew;
...
$sql="UPDATE brands SET brand=:brandname".($file['name']?",img=:destination":"")." WHERE brand_id=:brand_id;";
                ...
                <div class="main-page">
                    <div class="container-fluid">
                        <div class="row page-title-div">
                            <div class="col-md-6">
                                <h2 class="title">Update Brand</h2>
                            </div>
                                            ...
                                            <div class="form-group has-success">
                                                ...
                                                <div class="">
                                                    <input type="text" name="brandname"
                                                        value="<?php echo htmlentities($result->brand);?>"
                                                        required="required" class="form-control" id="success">
                                                </div>
                                            </div>
                                            <div class="form-group has-success">
                                                <label for="success" class="control-label">Brand Logo</label>
                                                <div class="">
